			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6">
                            <input type="text" id="mobile" name="mobile" required class="form-control col-lg-12"/>
                        </div>
					</div>
					<div class="form-group">
...
$(document).ready(function (){	
	...
	load_data = function load_data(search_txt){
		...
		$.ajax({
			url: project_url+"controller/stakeholderController.php",
			dataType: "json",
			type: "post",
			async:false,
			data: {
			...
			success: function(data){
				...
				if(!jQuery.isEmptyObject(records_array)){
					...
					var colums_array=["id*identifier*center", "name","email","mobile*center","status"];
...
$(document).ready(function () {		
	var url = project_url+"controller/stakeholderController.php";
			...
			success: function(data){
				if(!jQuery.isEmptyObject(data.records)){
					$.each(data.records, function(i,data){ 
						...
						if(data.status==0){
                            $("#emp_form #status").iCheck('uncheck');
                        }
