            ...
            <div style="height:250px; width:100%; overflow-y:scroll">
                <table id="category_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
                    ...
                    <tr class="headings">
                        ...
                        <th class="column-title" width="10%">Parent Head</th>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <input type="hidden" id="project_id" name="project_id" class="form-control col-lg-12"/>
                                </div>
                                ...
                                <input type="hidden" class="form-control" name="head_type" id="head_type" value="3"/>
                            </div>
							<div class="form-group">						
...
<script>
    ...
    */
	...
	$("#parent_head_name").on('keyup', function(){
		if($(this).val()==""){ 
			$(this).next().val("");
		}
	})
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(!jQuery.isEmptyObject(records_array)){
                        ...
                        var colums_array=["id*identifier*hidden","name","project_name","code","parent_name"];
