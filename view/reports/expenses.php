                    ...
                    success: function(data){
                        ...
                        if(!jQuery.isEmptyObject(data.records)){
                            if(report_type==1){
                                ...
                                html += '<th style="text-align:right; padding-right: 5px">Expense Amount</th></tr></thead><tbody>';
                        ...
                        if(project_id!=''){
                            html ='<div style="text-align:center;width:850px;"><div style="text-align:left;">' +
                                ...
                                '<h2 style="text-align:center" id="report_head">Expense Report For '+project_name+'</h2><table width="100%">' +
                            ...
                            html ='<div style="text-align:center;width:850px;"><div style="text-align:left;">' +
                                '<input name="print" type="button" value="Print" id="printBTN" onClick="printpage();" /></div>' +
                                '<h2 style="text-align:center" id="report_head">Expense Report</h2><table width="100%">' +
                                '<tr><th width="60%" style="text-align:left"><small>'+serach_areas+'</small></th>' +
                                '<th width="40%"  style="text-align:right"><small>Printed By: '+user_name+', Date:'+todate+'</small></th></tr></table>'+html;
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                var project_name = ''
                                if(!jQuery.isEmptyObject(data.records)){
                                    html+="<tr><td  colspan='"+(colspan+1)+"' style='text-align: left; font-weight:bold; height:40px'>Liability Paid</td></tr>"
