        ...
        <table id="category_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
            <thead >
                <tr class="headings">
                    ...
                    <th class="column-title" width="10%">Head Type</th>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12">Expense Head<span class="required">*</span></label>
					...
					<div class="form-group">						
                        ...
                        <input type="hidden" class="form-control" name="head_type" id="head_type" value="1"/>
