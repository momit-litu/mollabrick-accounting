                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="hidden" id="head_id" name="head_id" value="1"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
							<select  id="stakeholder" name="stakeholder_id"  class="form-control col-lg-12" > 
    ...
    */
    $(document).ready(function () {
        ...
        $('#save_expense_info').click(function(event){
			...
			else if($.trim($('#stakeholder').val()) == ""){
                success_or_error_msg('#form_submit_error','danger',"Please select a stakeholdetr","#stakeholder");
            }
            else{
