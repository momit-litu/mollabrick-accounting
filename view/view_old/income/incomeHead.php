			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12">Income Head<span class="required">*</span></label>
					...
					<div class="form-group">						
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							...
							<input type="hidden" class="form-control" name="head_type" id="head_type" value="2"/>
